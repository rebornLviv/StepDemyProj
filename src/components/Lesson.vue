        ...
        <div class="rate">
            <template>
                <div class="text-center">
                    <v-rating v-model="rating" background-color="black" half-increments dark size="30px" ripple color="yellow" @input="rateStars"></v-rating>
                </div>
            </template>
        </div>
    </v-row>
...
export default {
    ...
    methods: {
        ...
        rateStars() {
            ...
            this.$store.dispatch('rateLesson', {
                rating,
                videoUrl,
                category
            })
